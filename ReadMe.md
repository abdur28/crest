<p align="center">
  <img src=".github/assets/atoll-logo.png" alt="Crest" width="120">
</p>
<h1 align="center">Crest — DynamicIsland for macOS</h1>
<p align="center"><i>A private build maintained by <b>Bytesphere</b>, forked from Atoll.</i></p>

> ## 🙏 Appreciation
> **Crest is a fork of [Atoll](https://github.com/Ebullioscopic/Atoll) by Ebullioscopic**, and exists entirely because of their work. Every feature described below was built by the Atoll authors and contributors — Crest simply rebrands and tailors it for a small circle of friends. Heartfelt thanks to the entire Atoll team. 💙
>
> Crest is a modified **GPL v3** redistribution and is **not affiliated with or endorsed by** the Atoll project. Please support and ⭐ the original: **https://github.com/Ebullioscopic/Atoll**

---

<sub>Everything below is Atoll's original README, preserved with appreciation.</sub>
